...
public class GamePanel extends JPanel implements ActionListener, KeyListener{
    ...
    public static Player fishSelect;
    ...
    public void paintComponent(Graphics g) {
        ...
        if (gameOver) {
            ...
            g.setFont(new Font("Arial", Font.BOLD, 24));
            g.drawString("Press SPACE to restart", 290, 350);

            g.drawString("Score: " + gameScore, 360, 450);
            g.drawString("Time played: " + elapsed + "s", 320, 485);
        }
    }
