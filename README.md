...
This is a flappy bird inspired game that has login, register, background and game sounds, as well as highscore saving to the user.

Players must control a bird and navigate through pipes without crashing, earning points for each successful pass using the spacebar.
